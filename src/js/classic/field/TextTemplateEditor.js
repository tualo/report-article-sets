...
Ext.define('Tualo.reportarticlesets.form.field.SetsAreaWindow', {
    extend: 'Ext.form.field.Text',
    mixins: ['Tualo.reportarticlesets.Trigger'],
    alias: 'widget.tualo_report_article_set_area_window',
    requires: [
        'Ext.form.field.TextArea'
    ],
    triggers: {
        opends: {
            ...
            handler: async function (btn) {
                ...
                var wnd = Ext.create('Ext.Window', {
                    title: 'Artikel Sets',
                    items: [{
                        xtype: 'dsview_view_editor_blg_sets_artikel',
                    }]
